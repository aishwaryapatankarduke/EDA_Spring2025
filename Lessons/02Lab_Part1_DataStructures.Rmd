...
matrix1
#matrix1 has 05 rows and 04 columns

matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) #
matrix2
#matrix2 has 05 rows and 04 columns
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # to hash View command before knitting  
