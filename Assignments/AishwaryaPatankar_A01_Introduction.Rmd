...
> Answer: Excited to learn a new coding language

3. Are there any components of the course about which you feel apprehensive?

> Answer: Remembering the different code lines and sequence of coordinating between Console, Terminal commands in R studio and maintaining synchronization on GitHub
...
> Answer: https://github.com/aishwaryapatankarduke/EDA_Spring2025.git
